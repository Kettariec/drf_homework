...
class Payment(models.Model):
    ...
    paid_course = models.ForeignKey('study.Course', on_delete=models.CASCADE, **NULLABLE,
                                    verbose_name='оплаченный курс', related_name='payment')
    paid_lesson = models.ForeignKey('study.Lesson', on_delete=models.CASCADE, **NULLABLE,
    ...
    type = models.CharField(max_length=20, verbose_name='способ оплаты',
                            choices=PaymentType.choices, default='TRANSFER_TO_ACCOUNT')
